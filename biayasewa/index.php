            ...
            <div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-primary">
						...
						<button data-toggle="modal" data-target="#myModal" class="btn btn-success btn-sm"><span class="fa fa-plus"></span> Tambah Data Biaya Transaksi</button></div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><center>ID Mobil || Mobil<center></th>
									...
									?>
										<tr>
											...
											<td><?php echo $data['id_mobil'] ?> || <?php echo $data['type_mobil'] ?></td>
