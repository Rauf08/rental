...
?>
		<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo $root; ?>dashboard/index.php"><b>MANUNGGAL RENT CAR</b></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						<li>
							<center><img src="<?php echo $root; ?>/assets/gambar/logo.jpg" class="img-responsive" width="100%"><span class="masked"> </span></center>
						</li>
						<li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo $root; ?>biayasewa/index.php">Transaksi Biaya</a>
                                </li>
                                <li>
